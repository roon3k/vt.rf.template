...
<?if(count($arResult["STORES"]) > 0):?>
	...
	<div class="stores_block_wrap">
		<div class="block_title text-upper font_xs font-bold"><?=Loc::getMessage('STORES_TITLE_ITEM')?><?=CNext::showIconSvg("close", SITE_TEMPLATE_PATH."/images/svg/Close.svg");?></div>
		<div class="block_wrap scrollbar">
		...
		<div class="more-btn text-center">
			<a href="<?=$arParams['MORE_URL'];?>" class="btn btn-default transition_bg"><?=Loc::getMessage('MORE_LINK')?></a>
		</div>
	</div>
<?endif;?>