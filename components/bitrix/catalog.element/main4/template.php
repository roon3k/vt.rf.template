...
$templateData = array(
	...
	'LINK_PODBORKI' => $arResult["PROPERTIES"]["PODBORKI"],
);
...
if(($showProps && !$arResult["GROUPS_PROPS"]) || count($arResult["VISIBLE_PROPS"]) <= $arParams['VISIBLE_PROP_COUNT'])
	$showProps = false;
			...
			<?$frame = $this->createFrame()->begin();?>
								...
								<div class="top_props">
									...
									<div class="props props_list">
										...
										<?endif;?>
											...
											<?endforeach;?>
										<?if($bShowMoreLink):?>
											<div class=""><span class="choise colored" data-block=".tabs_section a[href='#<?= $arParams['PROPERTIES_DISPLAY_LOCATION'] === 'TAB' ? 'props' : 'descr'; ?>']"><?=GetMessage('ALL_CHARS');?></span></div>
										<?else:?>
											</div>
										<?endif;?>
									</div>
				...
				<div class="prices_block">
					<div class="cost prices clearfix">
						...
						$arDiscount=array();
						if($arDiscounts)
							$arDiscount=current((array)$arDiscounts);?>
