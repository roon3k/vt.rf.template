...
<?
//$list = CIBlockSection::GetNavChain(false,$arResult["SECTION"]["ID"], array(), true);
$navChain = CIBlockSection::GetNavChain($arParams["IBLOCK_ID"], $arParams["SECTION_ID_FOR_BIG_DATA"]);
?>
<?
...
<!-- <div class="section_block">
	<? $APPLICATION->IncludeComponent(
		...
		array(
			...
			"SECTION_CODE" => $childSection["CODE"],
			...
			"CACHE_FILTER" => "Y",
			"SECTION_VER" => $arParams["SECTION_ID_FOR_BIG_DATA"]
		),
		$component,
		array('HIDE_ICONS' => 'Y')
	); ?>
			...
			<div class="middle_info main_item_wrapper">
				<div class="like_wrapper">
					<? if ($arParams["DISPLAY_WISH_BUTTONS"] != "N" || $arParams["DISPLAY_COMPARE"] == "Y"): ?>
						<div class="like_icons iblock new_card_like_icons">
							<? if ($arParams["DISPLAY_WISH_BUTTONS"] != "N"): ?>
								<? if (!$arResult["OFFERS"]): ?>
				...
				<div class="like_icons block" style="display:none!important">
					<div class="like_icons list static icons">
						<? if ($arParams["DISPLAY_WISH_BUTTONS"] != "N"): ?>
							<? if ($arskuAddToBasketData['CAN_BUY']): ?>
								<div class="wish_item_button o_<?= $arSKU["ID"]; ?>">
				...
				<div class="card_flex">
					<div class="prices_block new_card_prices_block">
						<div class="cost prices clearfix">
