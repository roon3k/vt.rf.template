				...
				<div class="col-md-<?=$class;?>">
					...
					<?else:?>
						<?if($arParams["PROPERTIES_DISPLAY_TYPE"] != "TABLE"):?>
							<div class="props_block narrow" id="<? echo $arItemIDs["ALL_ITEM_IDS"]['DISPLAY_PROP_DIV']; ?>">
