		...
		<div class="basket-checkout-section">
			<div class="basket-checkout-section-inner">
							...
							<div class="basket-coupon-block-field">
								<div class="form">
									<div class="form-group" style="position: relative;">
										...
										<span class="basket-coupon-block-coupon-btn"><?=CNext::showIconSvg("coupon", SITE_TEMPLATE_PATH.'/images/svg/catalog/arrow_coupon.svg');?></span>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="basket-checkout-section-right">
					<?if (CNext::GetFrontParametrValue('SHOW_ONECLICKBUY_ON_BASKET_PAGE') === 'Y'):?>
						<?
							if(!empty($arParams['OFFERS_PROPS'])) {
								$offerTreeProps = implode(',', $arParams['OFFERS_PROPS']);
							}
						?>
						<div class="basket-checkout-block basket-checkout-btn ocb">
							<span class="oneclickbuy btn btn-default btn-lg fast_order" data-offer-tree-props="<?=$offerTreeProps ?: ''?>" onclick="oneClickBuyBasket(this)">
