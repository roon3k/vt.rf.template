...
$APPLICATION->AddViewContent('more_text_title', '<div class="basket-back font_xs"><a href="'.CNext::GetFrontParametrValue('CATALOG_PAGE_URL').'" class="basket-back__link muted">'.Loc::getMessage('SBB_BACK_CATALOG_TITLE').'</a></div>');
