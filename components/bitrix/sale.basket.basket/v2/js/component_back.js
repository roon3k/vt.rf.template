(function () {
    ...
    BX.Sale.BasketComponent = {
      ...
      checkMinPrice: function () {
        ...
        if (arNextOptions["PRICES"]["MIN_PRICE"] && arNextOptions["PRICES"]["MIN_PRICE"] > this.result.allSum) {
      ...
      //   if (itemData) {
      //     $.ajax({
      //       url: arNextOptions["SITE_DIR"] + "ajax/item.php?delete_linked_services=" + itemData["PRODUCT_ID"],
      //       type: "post",
