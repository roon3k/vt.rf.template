...
$APPLICATION->AddChainItem(GetMessage("CATALOG_COMPARE_TITLE2"));
$APPLICATION->SetPageProperty("title", GetMessage("CATALOG_COMPARE_TITLE2"));
$APPLICATION->SetTitle(GetMessage("CATALOG_COMPARE_TITLE2"));
...
if ($arRegion) {
	...
	if ($arRegion['LIST_STORES'] && reset($arRegion['LIST_STORES']) !== 'component') {
		$arParams['STORES'] = array_keys($arRegion['LIST_STORES']);
	}
}
