...
<?$ElementID = $APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_BLOCKS_ORDER" => ($arParams["DETAIL_BLOCKS_ORDER"] ? $arParams["DETAIL_BLOCKS_ORDER"] : 'tizers,complect,nabor,tabs,stores,char,galery,services,gifts,goods,exp_goods,assoc_goods,recomend_goods,podborki,blog'),
		...
		"BIGDATA_PATH_TEMPLATE" => $this->__folder.'/page_blocks/'.$sViewBigDataBottomTemplate.'.php',
