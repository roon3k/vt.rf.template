<?$APPLICATION->IncludeComponent("bitrix:catalog.bigdata.products", CNext::checkVersionExt(), array(
	...
	"PAGE_ELEMENT_COUNT" => $displayElementSlider,
	"SHOW_FROM_SECTION" => (isset($arParams["BIG_DATA_SHOW_FROM_SECTION"]) && $arParams["BIG_DATA_SHOW_FROM_SECTION"] === "Y" ? "Y" : "N"),
	...
	"SECTION_ELEMENT_ID" => $arResult["SECTION"]["ID"],
	"SECTION_ELEMENT_CODE" => $arResult["SECTION"]["CODE"],
	"ID" => $ElementID,
