	...
	<? if ($blockViewType): ?>
		...
		<? else: ?>
			<span id="<?= $injectId ?>_items"
				class="bigdata_recommended_products_items flexslider loading_state shadow border custom_flex top_right"
													...
													<? if ($arParams["SALE_STIKER"] && $arItem["PROPERTIES"][$arParams["SALE_STIKER"]]["VALUE"]) { ?>
														<div>
															<div class="sticker_sale_text">
																<?= $arItem["PROPERTIES"][$arParams["SALE_STIKER"]]["VALUE"]; ?></div>
														</div>
													<? } ?>
												</div>
											...
											<div class="item_info">
												<div class="item_info--top_block">
													<div class="item-title js-notice-block__title">
														<a href="<?= $arItem["DETAIL_PAGE_URL"] ?>?RID=<?= $arResult["RID"] ?>"
																	...
																	<div class="votes_block nstar with-text">
																		<div class="ratings">
																			...
																			<div class="inner_rating" title="<?= $message ?>">
																				<? for ($i = 1; $i <= 5; $i++): ?>
																					<div
																						class="item-rating <?= $i <= $arItem['PROPERTIES']['EXTENDED_REVIEWS_RAITING']['VALUE'] ? 'filled' : '' ?>">
																					</div>
																				<? endfor; ?>
																			</div>
																		</div>
