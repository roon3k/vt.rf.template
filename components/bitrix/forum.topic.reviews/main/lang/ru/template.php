...
$MESS['JERROR_REQUIRED_FIELD'] = 'Заполните это поле';
$MESS['JERROR_NO_TOPIC_AUTHOR_NAME'] = 'Вы должны ввести имя';
...
$MESS["ANONS_TEXT_FORUM"] = "У данного товара нет отзывов. Станьте первым, кто оставил отзыв об этом товаре!";
$MESS["COMM_COMMENT_OK_AND_NOT_APPROVED"] = "Комментарий добавлен и будет показан после одобрения модератором.";
?>