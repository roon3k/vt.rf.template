...
{
	$arParentSection = CNextCache::CIBLockSection_GetList(array('SORT' => 'ASC', 'NAME' => 'ASC', 'CACHE' => array('TAG' => CNextCache::GetIBlockCacheTag($arParams['IBLOCK_ID']), 'MULTI' => 'N', "CACHE_GROUP" => array($arParams["CACHE_GROUPS"]==="N"? false: $USER->GetGroups()))), array('ID' => $arParams['PARENT_SECTION']), false, array('ID', 'IBLOCK_ID', 'LEFT_MARGIN', 'RIGHT_MARGIN'));
...
if($arResult['SECTIONS'])
{
	...
	foreach($arResult['SECTIONS'] as $key => $arSection)
	{
		...
		CNext::getFieldImageData($arResult['SECTIONS'][$key], array('PICTURE'), 'SECTION');
	}
