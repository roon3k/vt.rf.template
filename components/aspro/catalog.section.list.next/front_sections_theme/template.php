...
<? if ($arResult['SECTIONS']): ?>
	...
	<div class="new_section_tab_block <?= ($bCompactViewMobile ? 'compact-view-mobile' : '') ?>">
		...
		<div class="list items">
			<div class="row margin0 flexbox slick-slider main">
	...
	<script>
		$(document).ready(function() {
			$('.slick-slider').not('.slick-initialized').slick({
				...
				arrows: true,
				slidesToShow: 4,
				prevArrow: `<button type="button" class="slick-prev main"><svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-width="2" d="m15 6l-6 6l6 6"/></svg></button>`,
				nextArrow: `<button type="button" class="slick-next main"><svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-width="2" d="m9 6l6 6l-6 6"/></svg></button>`,
				slidesToScroll: 1,
				responsive: [{
						breakpoint: 768,
						settings: {
