        ...
        <ul class="nav nav-pills w-100 mm-flex">
            ...
            <li class="nav-item">
			<a href="https://wa.me/79032222456?text=Здравствуйте%2C+у+меня+есть+вопрос" class="nav-link">
